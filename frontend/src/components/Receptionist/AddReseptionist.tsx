...
export default function AddReseptionist({ onAddPatient }: AddPatientProps) {
    ...
    const userTypeId = 5; // Receptionist user type
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            const data = await PostApi(`/users`, newReceptionist);
            if (!data?.error) {
                message.success("Receptionist added successfully!");
                onAddPatient?.(newReceptionist);
    ...
    const loadingOverlay = loadingStates.departments || loadingStates.extraFields;
                ...
                <Card
                    ...
                    title={
                        <div className="flex items-center gap-4 p-2">
                            ...
                            <div>
                                <Title level={3} className="m-0 text-gray-900">Add New Receptionist</Title>
                                <Text type="secondary" className="text-base">Fill in all required receptionist details to create a new record</Text>
                            </div>
                        </div>
                    }
                    extra={
                            ...
                            >
                                <div className="flex flex-col sm:flex-row gap-4 justify-end">
                                    ...
                                    >
                                        ...
                                        {isLoading ? "Adding Receptionist..." : "Add Receptionist"}
                                    </Button>
                                </div>
                            </motion.section>
                        </Form>
