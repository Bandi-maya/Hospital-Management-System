...
export default function AddDoctor({ onAddNurse }: AddNurseProps) {
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            message.error("Error occurred while adding the doctor.");
        } finally {
            setIsLoading(false);
                ...
                <Card
                    ...
                    title={
                        <div className="flex items-center gap-4 p-2">
                            ...
                            <div>
                                <Title level={3} className="m-0 text-gray-900">Add New Doctor</Title>
                                <Text type="secondary" className="text-base">Fill in all required doctor details to create a new record</Text>
                            </div>
                        </div>
                    }
                    extra={
